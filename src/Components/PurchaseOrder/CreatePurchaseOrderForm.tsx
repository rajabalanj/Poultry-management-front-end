...
const CreatePurchaseOrderForm: React.FC = () => {
  ...
  return (
    <>
      <PageHeader title={formStep === 'createOrder' ? "Create New Purchase" : `Add Payment for PO #${newPurchaseOrder?.id}`} buttonVariant="secondary" buttonLabel="Back to List" buttonLink="/purchase-orders" />
